...
export default function MentorPolicies() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Chính sách hệ thống</h1>
        <p className="text-muted-foreground">
          Mentor cần tuân thủ các chính sách sau khi hướng dẫn học viên.
        </p>
      </div>
